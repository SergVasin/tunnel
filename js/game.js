MG.game = (function () {
    ...
    var getLevelString = function () {
        return mLevel ? 'УРОВЕНЬ ' + mLevel : 'КВАЛИФИКАЦИОННЫЙ УРОВЕНЬ';
    }

    var Messages = {
        START: {
            title: getLevelString,
            text:  function () {return 'НАЧАТЬ';}
        },
        CRASH: {
            title: function () {return 'СТОЛКНОВЕНИЕ';},
            text:  function () {return 'ПОВТОР';}
        },
        GAME_OVER: {
            title: function () {return 'КОНЕЦ ИГРЫ';},
            text:  function () {return 'НАЧАТЬ ЗАНОВО';}
        },
        FINISH: {
            title: function () {return 'УРОВЕНЬ ЗАВЕРШЕН';},
            text:  function () {return 'ПРОДОЛЖИТЬ';}
        }
    };
